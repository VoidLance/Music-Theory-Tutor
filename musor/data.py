...
def scale_from_key(key_name: str):
    ...
    print("=" * (len(f"{key_name_clean} {scale_label}") + 4))
    print()
    print("How to build it:")
    print("1. Pick the root note of the key.")
    print("2. Use the key signature to know which notes are altered.")
    print("3. Move step by step through the scale, keeping the correct interval pattern.")
    if not is_minor:
        print("4. Major formula: whole, whole, half, whole, whole, whole, half.")
        print("5. Apply that pattern from the root and keep the required accidentals.")
    else:
        print("4. Natural minor formula: whole, half, whole, whole, half, whole, whole.")
        print("5. Use the relative major to confirm the key signature, then build from the minor tonic.")
    print()
    print(f"Scale: {' '.join(scale)}")
    print()
    print("Key idea:")
    print("- The key name gives the tonic and the key signature.")
    print("- The pattern confirms the correct spacing of the notes within that key.")
    print("- Accidentals belong to the key; they are not changed just because of their position in the scale.")
...
def scales_overview():
    ...
    print("======")
    print()
    print("A scale is a sequence of notes arranged by a repeating interval pattern.")
    print()
    print("Key + tonic")
    print("- The key name gives you the tonic.")
    print("- The key signature tells you which accidentals belong to that key.")
    print("- Example: G major = tonic G, key signature contains F#.")
    ...
    print()
    print("Patterns")
    print("- Major: whole, whole, half, whole, whole, whole, half")
    print("- Natural minor: whole, half, whole, whole, half, whole, whole")
    print()
    print("Use the pattern as a check on the spacing within the key, not as a second independent way of making the key.")
    print()
    print("Examples")
    print("- G major: G A B C D E F# G")
    print("- A minor: A B C D E F G A")
    print()
    print("Key idea")
    print("The key name gives the tonic and the key signature, and the pattern confirms the spacing")
    print("required for the major or minor structure. Accidentals do not change because of position;")
    print("they belong to the key, and the interval pattern confirms that the scale is correctly built.")
...
def songwriting_guide():
    print("Songwriting guide")
    print("=================")
    print("Songwriting is not just writing a tune. It is a process of deciding what the song should feel like, what it should say, and how each musical choice supports that intention.")
    print("The best songs usually feel conscious, not accidental. Every element is chosen: the key, the mood, the chord movement, the melody, the rhythm, the arrangement, and the lyric language.")
    print("")
    print("1. Start with the emotion, not only the chord")
    print("----------------------------------------------")
    print("Before writing notes, decide what the song is trying to make the listener feel.")
    print("Ask: Is this song about longing, release, danger, joy, confusion, nostalgia, hope, grief, rebellion, or tenderness?")
    print("A clear emotional target helps every decision become easier. The key, the mode, the rhythm, and the chord shapes should all support the same emotional aim.")
    print("For example, a minor key often feels reflective, tense, or melancholy, while a major key often feels brighter and more open. But the emotion should not be guessed by key alone; it depends on the melody, rhythm, and harmonic shape too.")
    print("If the emotion is fear, you might want a low register, tight rhythmic motion, unresolved chords, and a melody that feels tense or restricted.")
    print("If the emotion is celebration, you might use wider melodic leaps, a driving rhythmic pulse, strong tonic returns, and brighter colours in the harmony.")
    print("Use the emotional idea as the first filter for your decisions.")
    print("")
    print("2. Choose the sound of the song before the details")
    print("------------------------------------------------------")
    print("A useful songwriting habit is to decide the sound palette first.")
    print("Ask: What should this song sound like in the room? Warm or cold? Dense or sparse? Simple or layered? Intimate or huge? Delicate or aggressive?")
    print("This is where the choice of instrumentation matters.")
    print("The song may be built around guitar, piano, bass, drums, strings, synth, or a combination of these. Each instrument has a different emotional job.")
    print("- A bass line gives weight, pulse, and harmonic grounding.")
    print("- A guitar or piano can provide harmonic colour and rhythm.")
    print("- Drums or percussion create form, energy, and movement.")
    print("- Strings or synths can add atmosphere, sustain, and emotional texture.")
    print("- A vocal line usually carries the meaning, character, and emotional centre of the song.")
    print("When writing for multiple instruments, treat each instrument as having a role, not just a note to fill in the space.")
    print("A strong arrangement usually asks: what is the bass doing, what is the harmony doing, what is the melody doing, and what is the rhythm section doing at each point of the song?")
    print("Don’t let every instrument do the same job. Divide the musical weight intentionally.")
    print("For example, the bass can underline the root motion while the guitar adds colour, the melody carries the emotional line, and a pad or strings create a sense of atmosphere.")
    print("")
    print("3. Compose for multiple instruments with clear roles")
    print("------------------------------------------------------")
    print("Writing for several instruments is not just a matter of stacking notes together. It is a matter of making each part support a different musical function.")
    print("A common and effective way to plan this is to define the job of each part before writing any phrases.")
    print("- Melody: carries the idea, hook, or emotional line")
    print("- Harmony: gives the emotional and tonal frame")
    print("- Bass: supports the harmony and pulse")
    print("- Rhythm section: locks the groove and keeps the energy moving")
    print("- Textures and pads: add atmosphere and colour")
    print("- Lead or counter-melody: adds contrast or shape")
    print("Different instruments also change the way the harmony sounds. A piano voicing, a guitar chord shape, a synth pad, and a string section all create different emotional colours even when the same chord is played.")
    print("This is why arranging is a compositional tool, not an afterthought. The voicing and timbre change the emotional impact of the harmony.")
    print("A chord can be the same note set but feel completely different depending on instrumentation, register, dynamic, and articulation.")
    print("If you are writing for a full arrangement, think in terms of interaction: what happens between the vocal line and the harmony, what does the bass add, and how do the textures shape the emotional arc?")
    print("")
    print("4. Choose notes and chord progressions consciously")
    print("----------------------------------------------------")
    print("A chord progression is not just a set of labels. It is a sequence of emotional decisions.")
    print("Each chord changes the listener's sense of direction, tension, and release. The job of the progression is to carry the song forward.")
    print("A simple beginner principle is: choose chords that make the emotional point clear.")
    print("- A tonic chord gives home and stability.")
    print("- A dominant chord gives pull and tension.")
    print("- A subdominant or IV chord can feel broad, supportive, or open.")
    print("- A minor vi or bVI can give a darker, more reflective colour.")
    print("- A borrowed chord or altered chord can create surprise, drama, or urgency.")
    print("Choose the note choices with the same intention. Ask yourself whether the melody note is there because it is the most stable note, the strongest emotional note, or the note that creates tension before release.")
    print("This is where scale and mode choice matters. A mode gives you a different colour even when the fit with the chord progression is almost the same.")
    print("Dorian can feel soulful and wistful; Mixolydian can feel relaxed and bluesy; Lydian can feel open and airy; Locrian can feel tense and unstable; Aeolian can feel reflective and natural minor.")
    print("Do not decide a melody by accident. Decide what each note is doing: is it a stable anchor, a tension note, a passing tone, a colour note, or a leading tone?")
    print("That conscious choice is what makes a line feel intentional instead of random.")
    print("")
    print("5. Capture emotion in sound, not just in words")
    print("------------------------------------------------")
    print("Emotion is heard in the timbre, dynamics, register, rhythm, and interval choices, not just in the lyric content.")
    print("Even a simple progression can feel different if you change the instrument, the voicing, the articulation, the tempo, or the harmony.")
    print("A low, sustained note with soft attack can feel heavy and sad; a high, bright note with a strong attack can feel triumphant or nervous.")
    print("A repeated rhythmic figure can feel hypnotic, urgent, or mechanical depending on spacing and accent pattern.")
    print("The same lyric can feel completely different if delivered with a quiet, breathy melody or an aggressive, clipped rhythm.")
    print("This is why songwriting is not only harmony and lyrics. It is the whole sound of the idea.")
    print("Ask: what exact sound should this song have at the emotional centre? If you can hear it, you will be much more likely to write the right notes and chords to support it.")
    print("")
    print("6. Lyric writing: meaning, poetry, story, rhythm, sound, shape, and emphasis")
    print("-------------------------------------------------------------------------------")
    print("Lyrics are not just text on top of a melody. They are part of the musical shape of the song.")
    print("Good lyric writing begins with meaning: what is the song really about? What is the emotional truth of the line?")
    print("Then the lyric should find its poetic form. A line can be plain and direct, or it can use metaphor, contrast, sound, repetition, and image to deepen the feeling.")
    print("Storytelling matters when the song needs narrative. A lyric can describe a moment, a scene, a relationship, a memory, a conflict, or a transformation.")
    print("The best lyrics often carry one or more of these qualities:")
    print("- meaning: the idea or truth behind the line")
    print("- poetry: image, metaphor, or language that feels vivid and memorable")
    print("- storytelling: a scene or progression that unfolds in time")
    print("- rhythm: the natural musical pulse of the words")
    print("- sound: the texture of syllables and consonants")
    print("- shape: how the phrase rises and falls across the melody")
    print("- emphasis: where the lyric lands most strongly and where it should carry weight")
    print("A lyric line should fit the melody naturally. If the stresses of the words do not land on the strong beats of the line, the phrase will feel awkward.")
    print("The sound of words matters too. Repeated consonants, soft vowels, hard stops, and long vowels can all change the emotional colour of the line.")
    print("A line that is meant to feel fragile should often use softer sounds and shorter phrasing; a line meant to feel forceful should emphasise stronger consonants and firmer rhythm.")
    print("Poetry is not decoration; it is one of the ways meaning becomes memorable.")
    print("Writers should ask: where is the emphasis, where is the breath, what is the lyric object or image, and what is the emotional beat of each phrase?")
    print("A good lyric usually places the strongest ideas at the line's strongest melodic or rhythmic points.")
    print("This is where meaning and music become one idea.")
    print("")
    print("7. Shape the song as a whole, not just a section")
    print("----------------------------------------------------")
    print("A song has structure. It moves through tension, release, variation, and return.")
    print("The verse may feel intimate and restrained, the chorus may open out and feel bigger, the bridge may introduce tension or contrast, and the final chorus may deliver the emotional payoff.")
    print("Think of the song as a curve, not as a set of separate moments.")
    print("The verse should often establish the world of the song, the chorus should make the emotional statement clearer and larger, and the bridge should shift the viewpoint or add new pressure.")
    print("This is where a sense of shape matters: the song needs to rise, turn, and resolve in a convincing way.")
    print("A strong song typically does not feel like random sections placed together. It feels like a deliberate movement from one state to another.")
    print("")
    print("8. A practical songwriting workflow")
    print("-----------------------------------")
    print("A simple and reliable approach is this:")
    print("1. Decide the emotional core of the song.")
    print("2. Choose the key, mode, and overall sound palette.")
    print("3. Write a chord progression that supports that feeling.")
    print("4. Build a melody that carries the emotional centre and makes the phrase memorable.")
    print("5. Write lyrics that fit the rhythm and reinforce the meaning.")
    print("6. Decide how each instrument will support the song without crowding the core idea.")
    print("7. Adjust the arrangement for shape, contrast, and emotional release.")
    print("8. Test the song by singing or playing it and listening for whether the emotional point still lands clearly.")
    print("If the song feels flat, ask what part is missing: the harmony, the melody, the lyric meaning, the rhythm, the arrangement, or the emotional clarity.")
    print("This is the real craft: not writing everything at once, but making every musical decision serve the same creative intention.")
    print("")
    print("9. A final reminder")
    print("--------------------")
    print("Songwriting is not about guessing. It is about making choices with intention.")
    print("You are choosing the sound, the chord movement, the melody, the lyric language, and the arrangement in order to say something real and memorable.")
    print("Your job is not to fill every space with notes, but to make every note and every word matter.")
    print("When the harmony, arrangement, melody, and lyric all serve the same emotional truth, the song becomes convincing and lasting.")


def cello_guide():
    print("Cello guide")
    print("===========")
    print("The cello is a very different instrument from the bass or violin in the way it asks you to think about position, pitch, and reading.")
    print("The most important idea for a beginner is this: do not try to think of the cello as 'a small bass' or 'a violin with a lower sound'.")
    print("It is closer to both in some ways, but it has its own physical and musical logic.")
    print("")
    print("First, think in terms of home position")
    print("-------------------------------------")
    print("Home position is the basic starting setup for the left hand on the cello, and it is usually the same thing as first position for a beginner.")
    print("In first position, the hand sits in a relaxed, balanced shape around the neck, and the fingers are placed in their natural order: 1, 2, 3, 4, with the thumb supporting from behind.")
    print("In home position / first position, the first finger is usually placed a step above the open string, the second finger a step higher, the third finger another step, and the fourth finger sits at the next step after that.")
    print("This is the key idea: the finger spacings are not random. They are built around the pattern of whole steps and half steps that make up the scale.")
    print("A beginner should not be forcing the hand into a rigid shape. A relaxed hand with a clear finger order is much easier to keep stable and accurate.")
    print("When you are learning, aim for a consistent hand shape that lets each finger move cleanly without unnecessary tension in the wrist or knuckles.")
    print("")
    print("How to find a step without any visual aid")
    print("-----------------------------------------")
    print("You can find a step by feel, not by looking at the fingerboard.")
    print("Start with one open string and listen to the note. Then place the first finger so that the pitch rises by the next degree in the scale. If you are unsure, think of it like this: a step is the nearest ordinary movement from one note to the next, not a jump.")
    print("On cello, the easiest way to learn this is to use the ear and the hand together: play the open string, then place finger 1 and listen to the change. If it feels like a smooth, small movement that still keeps the note inside the same basic shape of the hand, you are likely close to the correct step.")
    print("Do not chase the note by memorising a hard number. Instead, listen for whether the sound is higher and whether the finger spacing feels smooth and natural in the hand.")
    print("A good beginner rule is: if the finger is placed in the natural line of the hand and the note sounds like the next step, it is probably correct. If it feels cramped, tense, or the pitch jumps in a way that does not match the scale shape, it is not in the right place.")
    print("You can also train your fingers by moving from open string to first finger, then to second, then third, then fourth, in the same motion each time. The step is the sensation of moving one closest note higher in a smooth chain, not the feeling of a large stretch.")
    print("This is how you build the correct starting position without any visual aid: you rely on the open-string anchor, the line of the fingers, and the sound of the step itself.")
    print("")
    print("The open strings and the first basic landmarks")
    print("---------------------------------------------")
    print("The cello's open strings are C, G, D, and A, from low to high.")
    print("That means the lowest string is C, then G, then D, then A.")
    print("This matters because the cello is tuned in fifths, just like the bass, but the actual note ranges and feel are different.")
    print("The open strings are your anchors. If you can tell where the open string sits on the staff and how it feels physically under the hand, you can find the rest of the notes much more easily.")
    print("For example, if you know the A string is the second highest string and you know what the note A looks like on the staff, then the finger pattern around it becomes much clearer.")
    print("The open strings are not just notes to memorise; they are the base from which all finger placement is built.")
    print("")
    print("How to find finger placement in home position")
    print("----------------------------------------------")
    print("Start by learning one string at a time.")
    print("On a single string, the easiest pattern is to work from the open string outward:")
    print("- first finger = a step above the open string")
    print("- second finger = another step above")
    print("- third finger = the next step")
    print("- fourth finger = the next step after that")
    print("This gives you the basic ascending scale pattern on the string.")
    print("The beginner mistake is to think of every finger as a fixed number without understanding the pattern between them.")
    print("The real learning goal is to feel the spaces: finger 1 to finger 2 is usually a whole step, finger 2 to finger 3 is another whole step, and finger 3 to finger 4 is usually the final step before the next position change.")
    print("You are not memorising random notes; you are learning a shape that repeats and can be shifted along the fingerboard.")
    print("As soon as you can feel that shape on one string, you can move it to another string and understand why the same finger pattern gives a different tune.")
    print("")
    print("What to do with the staff: reading and finding notes")
    print("------------------------------------------------------")
    print("Cello is often taught by reading sheet music and then finding the note on the instrument. This is a very good habit to build early.")
    print("A beginner should first ask: what string am I on, and what note is the staff showing me in relation to that string?")
    print("Do not look at the cello as a puzzle to be solved note by note in isolation. Instead, learn the note relationships:")
    print("- Find the open-string notes on the staff")
    print("- Learn where the basic scale degrees sit around them")
    print("- Recognise common shapes such as stepwise motion, thirds, and simple leaps")
    print("- Use the physical hand shape to locate notes rather than counting every single semitone from scratch")
    print("This way, the staff and the hand support each other. You are not trying to read the mental map and the physical map separately; you are learning them as one system.")
    print("If you are reading a note and you do not immediately know the place on the string, ask: is it near an open string, is it within the basic home-position pattern, or does it require a shift?")
    print("That is the beginner-friendly logic that makes reading less intimidating.")
    print("")
    print("How this differs from violin and bass")
    print("--------------------------------------")
    print("The cello is not the same as the violin.")
    print("On the violin, you often think in terms of small position shifts and a very close, more flexible hand setup. The instrument is higher, the strings are tuned in fifths, and the left-hand spacing is more immediately tied to the player’s hand mobility and the instrument's smaller size.")
    print("On the cello, the larger instrument and the lower register make the hand feel bigger and more grounded. The notes are physically farther apart in some ways, and the player's awareness of fingerboard geography is more important from the start.")
    print("The cello is also not the same as the bass, even though both are low strings and both are tuned in fifths.")
    print("The bass is often taught from a more pattern-based, fretboard-style viewpoint, especially because it is often played with frets and with a more direct left-hand shape based on intervals and scale positions.")
    print("The cello is different because the left hand is working with a continuous fingerboard, so the player must think more about the exact relation between finger pressure, string, and note, as well as careful placement in a more fluid position system.")
    print("The bass player often asks: 'What pattern do I need on this string?' The cello player often asks: 'Where am I in the hand position, what string am I on, and how does this note sit in relation to the open string and the surrounding scale?'")
    print("That difference matters. The cello is not just a bass with a different size; it requires a more nuanced awareness of hand shape, string-to-string movement, and reading in a staff-based system.")
    print("")
    print("A beginner-friendly practice plan")
    print("--------------------------------")
    print("1. Learn the open strings and their note names on the staff.")
    print("2. Practise single-string scales in home position before worrying about shifting.")
    print("3. Keep the hand relaxed and let the fingers fall into the correct line instead of squeezing the neck.")
    print("4. Play easy stepwise patterns and notice how the pitch changes with each finger.")
    print("5. Read short notes and find them on the string by using the open-string landmarks and the home-position shape.")
    print("6. Only move beyond home position once the basic finger patterns feel secure and you can read the notes without panic.")
    print("7. Think of shifts not as a new skill to memorize, but as a natural extension of the same hand pattern you already know.")
    print("")
    print("The big goal")
    print("------------")
    print("The beginner goal is not to play a huge amount of repertoire quickly. It is to learn the basic relationship between the fingerboard, the open strings, and the staff.")
    print("When you know how to find notes from home position, read simple lines, and understand why the hand shape matters, the rest of the cello becomes much more manageable.")
    print("That is when the instrument starts to feel musical instead of mechanical.")
    print("The best way to learn cello is to build a good physical habit early, keep the music readable, and treat the fingerboard as a set of patterns that can be trusted rather than guessed.")
    print("In other words: learn the hand shape, learn the string relationships, and learn the musical logic of the staff together.")
    print("That is the foundation that makes all future positions and repertoire easier to understand.")
